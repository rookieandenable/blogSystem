<template>
  <div id="content">
    <div class="article_wrap" v-for="item in articleList" v-bind:key="item.id">
      ...
      <div class="article_info">
        ...
        <el-tag v-else class="tag_margin" type="primary" v-for="tag in item.labels" v-bind:key="tag.id">{{ tag }}</el-tag>
        </span>
      </div>
